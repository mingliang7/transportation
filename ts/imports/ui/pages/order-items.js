...
// Declare template
let indexTmpl = Template.TS_orderItems,
    actionTmpl = Template.TS_orderItemsAction,
    newTmpl = Template.TS_orderItemsNew,
    editTmpl = Template.TS_orderItemsEdit;
...
indexTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ts.order.schema';
...
AutoForm.addHooks(['TS_orderItemsEdit'], hooksObject);
