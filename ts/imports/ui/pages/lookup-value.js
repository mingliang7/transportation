...
// Declare template
let indexTmpl = Template.TS_lookupValue,
    optionsTmpl = Template.TS_lookupValueOptions,
    formTmpl = Template.TS_lookupValueForm;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('ts.lookupValueById', currentData.lookupValueId);
        }
    });
});
...
AutoForm.addHooks(['TS_lookupValueForm'], hooksObject);
