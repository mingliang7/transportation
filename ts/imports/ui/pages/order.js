...
// Declare template
let indexTmpl = Template.TS_order,
    actionTmpl = Template.TS_orderAction,
    formTmpl = Template.TS_orderForm,
    showTmpl = Template.TS_orderShow;
...
indexTmpl.events({
    ...
    'click .js-invoice' (event, instance) {
        ...
        let path = FlowRouter.path("ts.invoiceReportGe", params, queryParams);
...
AutoForm.addHooks(['TS_orderForm'], hooksObject);
