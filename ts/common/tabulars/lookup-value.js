...
tabularOpts.name = 'ts.lookupValue';
tabularOpts.collection = LookupValue;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.TS_lookupValueAction},
    {data: "name", title: "Name"},
    {data: "private", title: "Private"},
    {
        data: "options",
        title: "Options",
        tmpl: Meteor.isClient && Template.TS_lookupValueOptions
    },
];
