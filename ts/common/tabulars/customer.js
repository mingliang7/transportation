...
tabularOpts.name = 'ts.customer';
tabularOpts.collection = Customer;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.TS_customerAction},
    {data: "_id", title: "ID"},
    ...
    {data: 'contact', title: 'Contact', tmpl: Meteor.isClient && Template.TS_customerContact},
];
